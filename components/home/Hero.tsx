			...
			<div className="relative z-10 flex min-h-screen flex-col px-4 pb-8 pt-28 sm:px-6 sm:pt-32 lg:px-28 lg:pt-48">
				...
				>
					<div className="w-full">
						<h1
							className="font-nian font-bold text-[4rem] leading-[0.64] tracking-[0.02em] text-[#fffdf8] sm:text-[5rem] md:text-[6.5rem] lg:text-[8rem] xl:text-[7.8rem]"
						>
							شقایق زارعی
							<br />
							<span className="font-extralight text-[2.5rem] sm:text-[3rem] md:text-[4.5rem] lg:text-[6rem] xl:text-[3.4rem] pt-16 h-fit flex leading-[1.2]">
								روان‌درمانی فردی 								{/* <br /> */}
								 و زوج‌درمانی
							</span>
						</h1>
					...
					<div className=" flex ">
						...
						<div className="self-end justify-self-end lg:mb-10" style={{ maxWidth: "850px" }}>
							...
							<p className="text-lg leading-9 text-white/92 sm:text-xl lg:text-2xl text-pretty tracking-[0.08em] ">
								من شقایق زارعی هستم. با بزرگسالان و زوج‌ها در زمینهٔ اضطراب، وسواس، دشواری‌های عاطفی و تعارض‌های رابطه کار می‌کنم. در جلسات، ابتدا شرایط و دغدغه‌های شما را بررسی می‌کنیم و سپس اهداف و مسیر درمان را متناسب با نیاز شما مشخص می‌کنیم.

							</p>
							<Button href="#contact">
								<span className=" text-xl font-bold">رزرو جلسه مشاوره</span>
							</Button>
						</div>
